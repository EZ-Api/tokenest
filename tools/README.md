...
## accuracy
Compares TokenX/NewAPI/UltraFast/Fast/Weighted against `tiktoken` (`o200k_base`) and writes a timestamped report.
...
Options:
- `-report-dir`: custom output directory (default: `tokenest/report`).
